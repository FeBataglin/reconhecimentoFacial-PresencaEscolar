...
export class FieldValidationUtil {
    ...
    constructor(
        ...
        this.disclaimerUtil = new DisclaimerUtil(poNotification, this.poI18nPipe, this.literals);
    }
    ...
    public vldFieldNumber(field: string, value: number, vldValue = false): boolean {
    ...
    public vldFieldFormat(field: string, value: string, format: string): boolean {
        let lOK = true;
